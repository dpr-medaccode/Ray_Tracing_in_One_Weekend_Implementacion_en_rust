...
use crate::{
    ...
    textura::{Textura, ajedrez::Ajedrez, color_solido::Color_solido},
...
fn main() {
    ...
    let material_suelo: Arc<dyn material::Material> =
        Arc::new(DifusoLambertiano::new(Arc::new(Ajedrez::new(
            0.50,
            Arc::new(Color_solido::new(BLANCO)),
            Arc::new(Color_solido::new(NEGRO)),
        ))));
